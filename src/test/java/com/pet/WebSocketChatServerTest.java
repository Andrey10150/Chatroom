...
@SpringBootTest(classes = com.pet.WebSocketChatApplication.class,webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class WebSocketChatServerTest {

    private static String TEST_USER = "name";
